...
if(SOS_SDK_TOOLCHAIN_DIR)
    set(SOS_SDK_TOOLCHAIN_SETTINGS -DTOOLCHAIN_DIR=${SOS_SDK_TOOLCHAIN_DIR})
endif()

if(SOS_SDK_TOOLCHAIN_HOST)
    set(SOS_SDK_TOOLCHAIN_SETTINGS ${SOS_SDK_TOOLCHAIN_SETTINGS} -DTOOLCHAIN_HOST=${SOS_SDK_TOOLCHAIN_HOST})
endif()
...
if(BUILD)
    if(INCLUDE_LIBRARIES)
        ...
        if(INCLUDE_LINK)
            ...
            sos_sdk_build_lib(${LIB_WORKSPACE_PATH}/sgfx ${INSTALL_LIBRARIES} link)
